...
<div class="container">
	<div style="width: 60%; margin: auto;">
		<form style="border-top: 2px solid black;" id="form" role="form"
			method="post" action="/admin/notice/update/${notice.id }">
			...
			<div style="width: 100%;">
				...
				<div
					...
					<fmt:formatDate pattern="yyyy-MM-dd" value="${notice.createdAt }" /></div>
				<div
					style="line-height: 39px; width: 20%; float: left; height: 35px; font-weight: bold; background-color: #eeeeee; text-align: center;">
					개시기간</div>
				<div
			...
			<div>
				<textarea
					...
					class="form-control" rows="5" name="content" >${notice.content }</textarea>
			</div>
			<div style="height: 40px; margin-top: 50px;">
				<button type="submit" class="btn_style" id="btnSave">등록</button>
				<button type="button" class="btn_style" id="btnList"
